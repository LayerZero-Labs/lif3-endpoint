...
export function getDeployedAddress(hre: HardhatRuntimeEnvironment, contractName: string): string {
    const data = require(`../../sdk/deployments/${hre.network.name}/${contractName}.json`)
    return data.address
}
...
export function getDeployedV1Address(hre: HardhatRuntimeEnvironment, contractName: string): string {
    ...
    const data = require(`../../../../layerzero-v1/evm/sdk/deployments/${hre.network.name}/${contractName}.json`)
    return data.address
}
